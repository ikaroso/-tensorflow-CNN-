...
def getdata():
    ...
    y1=list(unpickle("cifar/data_batch_1")[b'labels'])
    y2=list(unpickle("cifar/data_batch_2")[b'labels'])
    y3=list(unpickle("cifar/data_batch_3")[b'labels'])
    y4=list(unpickle("cifar/data_batch_4")[b'labels'])
    y5=list(unpickle("cifar/data_batch_5")[b'labels'])
